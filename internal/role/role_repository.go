...
func (r *RoleRepository) GetOneByID(ctx context.Context, id pgtype.UUID) ([]sqlc.GetRoleWithPermissionsRow, error) {
	return r.q.GetRoleWithPermissions(ctx, id)
}

func (r *RoleRepository) GetOneByIDWithSoftDeleted(ctx context.Context, id pgtype.UUID) ([]sqlc.GetRoleWithPermissionsWithSoftDeletedRow, error) {
...
func (r *RoleRepository) GetRoleIDByValue(ctx context.Context, value string) (pgtype.UUID, error) {
	return r.q.GetRoleIDByValue(ctx, value)
}
