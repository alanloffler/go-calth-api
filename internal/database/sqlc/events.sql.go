...
const getEventsInHorizon = `-- name: GetEventsInHorizon :many
SELECT
  start_date,
  end_date
FROM
...
type GetEventsInHorizonParams struct {
	BusinessID     pgtype.UUID        `json:"businessId"`
	ProfessionalID pgtype.UUID        `json:"professionalId"`
	HorizonEnd     pgtype.Timestamptz `json:"horizonEnd"`
	HorizonStart   pgtype.Timestamptz `json:"horizonStart"`
}

type GetEventsInHorizonRow struct {
	StartDate pgtype.Timestamptz `json:"startDate"`
	EndDate   pgtype.Timestamptz `json:"endDate"`
}

func (q *Queries) GetEventsInHorizon(ctx context.Context, arg GetEventsInHorizonParams) ([]GetEventsInHorizonRow, error) {
	rows, err := q.db.Query(ctx, getEventsInHorizon,
		arg.BusinessID,
		arg.ProfessionalID,
		arg.HorizonEnd,
		arg.HorizonStart,
	...
	defer rows.Close()
	var items []GetEventsInHorizonRow
	for rows.Next() {
		var i GetEventsInHorizonRow
